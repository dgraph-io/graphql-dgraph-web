...
*  needs to mention aplication/graphql - see https://graphql.org/learn/serving-over-http/#post-request, 
* needs to talk about the response format, 
* needs to mention the extensions (and how to turn them off - for self hosted dgraph there's a flag)
