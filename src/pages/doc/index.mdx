...
* [Schema] After you have got yourself started with with the quick start(**link**) and tutorials(**link**), you'll need the schema reference to find out about all the options of what can be in your schema.
