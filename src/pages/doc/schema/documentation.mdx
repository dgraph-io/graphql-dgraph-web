...
![SchemaDocumentationType](../../../images/schema-documentation/authors1.png "Schema Documentation On Types")
<p style="text-align: center;">Schema Documentation on Types</p>

![SchemaDocumentationCD](../../../images/schema-documentation/CustomDirectiveDocumentation.png "Schema Documentation On Custom Directive")
<p style="text-align: center;">Schema Documentation on Custom directive</p>
