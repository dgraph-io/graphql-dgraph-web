...
![Slash-GraphQL: Get Started](../../images/tutorial/todo/slash-graphql-1.png)

Let's go ahead and create a new deployment.

![Slash-GraphQL: Create deployment](../../images/tutorial/todo/slash-graphql-2.png)
...
![Slash-GraphQL: Deployment created ](../../images/tutorial/todo/slash-graphql-3.png)
