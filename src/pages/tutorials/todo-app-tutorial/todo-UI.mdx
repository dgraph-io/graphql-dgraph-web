...
### <a name="Create React App"></a>Create React app
...
### <a name="Setup Apollo Client"></a>Setup Apollo Client
...
### <a name="Queries and Mutations"></a>Queries and Mutations
...
### <a name="Auth0 integration"></a>Auth0 integration
