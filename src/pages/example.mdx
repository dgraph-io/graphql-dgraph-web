...
import {exampleMut1, exampleMut2, exampleMut2Vars, exampleMut3, exampleMut3Vars, exampleMut4, exampleMut5, exampleQry1, exampleQry2, exampleQry3} from "../utils/queries"
...
<GraphiQLWrapper defaultQuery={exampleMut1} />
...
<GraphiQLWrapper defaultQuery={exampleMut2} defaultVariables={exampleMut2Vars} />
...
<GraphiQLWrapper defaultQuery={exampleMut3} defaultVariables={exampleMut3Vars} />
...
<GraphiQLWrapper defaultQuery={exampleMut4} />
...
<GraphiQLWrapper defaultQuery={exampleMut5} />
...
<GraphiQLWrapper defaultQuery={exampleQry1} />

For a post it's

<GraphiQLWrapper defaultQuery={exampleQry2} />
...
<GraphiQLWrapper defaultQuery={exampleQry3} />
