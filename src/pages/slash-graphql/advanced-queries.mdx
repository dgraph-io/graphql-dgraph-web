...
We will be adding support to ratel and dgraph-js-http soon, and we are currently working on support for [live loader](https://dgraph.io/docs/deploy/#live-loader). Please join our [community](https://discuss.dgraph.io) for [release announcements](https://discuss.dgraph.io/tags/c/user/slash/33/release).
