...
* [Administering your Backend](./admin) covers topics such as how to programatically set your schema, and import or export your data
  ...
  * [Dropping Data](/slash-graphql/admin/drop-data) will guide you through dropping/deleting your Slash GraphQL backend data completely with and without dropping schema.
