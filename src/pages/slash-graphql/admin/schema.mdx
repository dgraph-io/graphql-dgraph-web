...
This endpoint works in a similar way to the [/admin](https://graphql.dgraph.io/doc/admin) endpoint of Dgraph, with the additional constraint of [requiring authentication](./authentication).
