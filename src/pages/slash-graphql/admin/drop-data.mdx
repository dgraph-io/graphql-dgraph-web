...
It is possible to drop all data from your Slash GraphQL backend, and start afresh while retaining the same endpoint. Be careful, as this operation is not not reversible, and all data will be lost. It is highly recommended that you [export](./import-export) your data before you drop your data.
